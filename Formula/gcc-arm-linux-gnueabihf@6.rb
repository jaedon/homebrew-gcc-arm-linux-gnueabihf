class GccArmLinuxGnueabihfAT6 < Formula
  ...
  url "https://github.com/jaedon/homebrew-gcc-arm-linux-gnueabihf/releases/download/gcc-6-arm-linux-gnueabihf/gcc-arm-linux-gnueabihf--6.5.0.big_sur.bottle.tar.gz"
